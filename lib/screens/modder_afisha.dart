...
import 'moderShowPage.dart';

class MPostersPage extends StatefulWidget {
  MPostersPage({Key key}) : super(key: key);

  @override
  _MPostersPageState createState() => _MPostersPageState();
}

class _MPostersPageState extends State<MPostersPage>
