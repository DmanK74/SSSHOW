...
class _AdminPageState extends State<AdminPage> with TickerProviderStateMixin {
  ...
  Future initApi() async {
    var url2 = "http://showconnect/get_all_v.php";
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text(_visitors[index]['id'].toString(),
                        style: TextStyle(
                          fontSize: 22,
                        )),
                    Text(_visitors[index]['NickName'].toString(),
                        style: TextStyle(
                          fontSize: 22,
                        )),
                    Padding(
                      ...
                      child: FlxTargetWell(
                        onTap: () async {
                          var url2 = "http://showconnect/set_to_modder.php";
                          // ignore: unused_local_variable
                          var res2 = await Dio().get(
                            url2,
                            queryParameters: {
                              "Visitor_id": _visitors[index]['id'].toString(),
                            },
                          );
                          await initApi();
